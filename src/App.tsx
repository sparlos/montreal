...
const DAY_PHOTOS: Record<number, Array<{ id: string; caption: string }>> = {
	1: [
		{ id: "1558618047-3c8d3197b8e4", caption: "Old Port" },
		{ id: "1501594907352-04cda38ebc29", caption: "Rue Saint-Paul" },
		{ id: "1519706200-ede3db38ce43", caption: "Vieux-Montréal" },
	],
	2: [
		{ id: "1519985261671-7b856b880e7b", caption: "Notre-Dame" },
		{ id: "1550684376-d307f4ba7bca", caption: "Old Montréal" },
		{ id: "1535385789888-1a50aac1e3f4", caption: "Bonsecours" },
	],
	3: [
		{ id: "1527576539890-dfa815648363", caption: "Rooftop Views" },
		{ id: "1534235826754-0a3572d1d6d0", caption: "Montréal at Dusk" },
	],
	4: [
		{ id: "1559827291-72ebec933bd8", caption: "Mount Royal" },
		{ id: "1543966888-7c1dc482a810", caption: "Kondiaronk" },
		{ id: "1534666163347-1ed8fe47c80c", caption: "City Skyline" },
	],
	5: [
		{ id: "1558618666-fcd25c85cd64", caption: "Au revoir!" },
		{ id: "1493714569041-04aa65bef7e1", caption: "Train Home" },
	],
};

function PhotoStrip({ dayNumber }: { dayNumber: number }) {
	const photos = DAY_PHOTOS[dayNumber] ?? [];
	...
	return (
		...
		>
			{photos.map(({ id, caption }, i) => (
				<motion.div
					key={id}
					className="polaroid"
					style={{ rotate: i % 2 === 0 ? -2 : 1.5 }}
					whileHover={{ rotate: 0, scale: 1.07, y: -6, zIndex: 10 }}
					transition={{ type: "spring", stiffness: 300, damping: 20 }}
				>
					<img
						src={`https://images.unsplash.com/photo-${id}?auto=format&fit=crop&w=280&h=200&q=75`}
						alt={caption}
